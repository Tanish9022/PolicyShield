...
export const PROMOTIONS: Promotion[] = [
  ...
  { promotion_id: 'promo_5', name: 'Standard 5%', discount_percent: 5, applicable_product_ids: ['prod_laptop_3'], eligible_segments: [], active: true, valid_from: '2023-01-01', valid_until: '2029-12-31' },
];
